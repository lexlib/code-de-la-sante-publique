...
rendue publique lors du dépôt de la liste.

Cette répartition est jointe à la liste de candidats. A défaut d'une telle indication, la répartition des suffrages se fait à
parts égales entre les organisations syndicales concernées. Cette répartition est indiquée sur les listes de candidats qui
sont affichées et sur le procès-verbal des opérations électorales.
